...
def get_last_5_entries_sales():
    """[Collects collumns of data from sales worksheet, collecting the last 5 entries for each sandwich and returns the data as a list of lists.]
    """
...
def calculate_stock_data(data):
    ...
    Args:
        data ([list]): [List of sales column for each sandwich for the last 5 markets.]
    """
